-- ============================================================================
-- V1: Esquema inicial del ERP La Casa del Chef (45 tablas, triggers, vistas,
-- indices y datos semilla). Flyway ejecuta cada migracion en una transaccion,
-- por lo que no se usa BEGIN/COMMIT.
-- En la base de desarrollo original este esquema se creo a mano; Flyway la
-- registra como linea base (baseline-version=1) y no vuelve a ejecutar esto.
-- ============================================================================
